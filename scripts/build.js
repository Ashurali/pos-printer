#!/usr/bin/env node
/**
 * Build script for ble-pos-printer.
...
function getTypesManager() { return `// Type declarations for ble-pos-printer/printer-manager
...
function getTypesSetup() { return `// Type declarations for ble-pos-printer/printer-setup
